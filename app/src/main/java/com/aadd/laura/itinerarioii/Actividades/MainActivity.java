...
public class MainActivity extends ListActivity implements android.view.View.OnClickListener {
    ...
    public void listLocations(){
        ...
        if(locationList.size()!=0) {
            ...
            ListAdapter adapter = new SimpleAdapter( MainActivity.this,locationList, R.layout.detalle_localizacion, new String[] { "id","nombre"}, new int[] {R.id.localizacion_Id, R.id.localizacion_nombre});
    ...
    public void listLocationByName(String name){
        ...
        if(locationList.size()!=0){
            ...
            ListAdapter adapter = new SimpleAdapter(MainActivity.this,locationList,R.layout.detalle_localizacion,new String[]{"id","name"},new int[]{R.id.localizacion_Id,R.id.localizacion_nombre});
            setListAdapter(adapter);
        }else{
